...
Ссылка на прототип http://46.173.16.84:8502/
Презентация приложена в репо. Сервер с апи падает из-за каких то проблем beget`a при тесте напишите сюда @rukabogga телега я его подниму.
